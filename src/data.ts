...
export const initialPortfolioData: PortfolioItem[] = [
  ...
  },
  {
    ...
    "philosophy": "高嶺土高溫燒製白瓷胎質，釉下高彩噴繪鮮明重現鸚哥魚斑斕鱗彩與珊瑚礁生態，加大寬手柄符合人體工學。",
    "tools": [
      "文創企劃",
      "陶瓷彩繪",
      "Photoshop",
  ...
  },
  {
    ...
    "philosophy": "精細棚拍搭配暗房數位精修，呈現暖金防偽底紋與壓印質感，泰式皇家浮雕幾何框線結合當代西方網格排版。",
    "tools": [
      "Illustrator",
      "Photoshop",
      "商品攝影",
  ...
  },
  {
    ...
    "philosophy": "實物棚拍結合光影技術優化金屬，塑料與矽膠漫反射，營造溫潤居家質感，草綠幾何網格展現東南亞風情。",
    "tools": [
      "行銷企劃",
      "排版設計",
      "商品攝影",
  ...
  },
  {
    ...
    "philosophy": "實景拍攝懸疑氣氛結合AI生成科幻夢境，在冷色調微光中靈活切換POV與景深。",
    "tools": [
      "Premiere Pro",
      "Photoshop",
      "AI生成",
  ...
  },
  {
    ...
    "philosophy": "網格系統編排滾筒銀，瓶身藍搭配醒目除菌黃，前後對比滾筒寫實插畫，數據化圖示精準傳達3分鐘去污成效。",
    "tools": [
      "Photoshop",
      "Illustrator",
      "排版設計",
  ...
  },
  {
    ...
    "philosophy": "嚴謹排版網格結合高動態鮮果視覺，精細高光折射與景深渲染，將實體店鋪燈箱提升為純粹的生活設計美學。",
    "tools": [
      "Photoshop",
      "Illustrator"
    ],
  ...
  },
  {
    ...
    "philosophy": "鮮明幾何水果底色搭配中英字藝排版，層次對齊與網格框線，將促銷折扣轉譯為具備極簡質感的行銷圖卡。",
    "tools": [
      "Photoshop",
      "Illustrator"
    ],
  ...
  },
  {
    ...
    "philosophy": "透過動態影像設計，完美展現鮮果茶飲的特色與活力，提升品牌形象與產品吸引力。",
    "tools": [
      "After Effects",
      "Premiere Pro",
      "Photoshop",
