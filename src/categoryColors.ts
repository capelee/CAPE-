export const categoryColors: Record<string, {
  ...
  "角色IP&插畫與貼圖": {
    ...
    highlightBorderDark: "border border-white/5 hover:border-white/10",
    ...
    highlightBorderLight: "border border-zinc-200/50 hover:border-zinc-300",
    ...
    highlightBorderSepia: "border border-[#E8DFCE]/50 hover:border-[#D0C098]",
  ...
  "亮點設計": {
    accent: "amber-400",
    rgbaGlow: "251, 191, 36",
    borderClass: "group-hover:border-amber-400/30",
    glowClass: "group-hover:shadow-amber-400/15",
    gradientClass: "from-amber-400/30 via-amber-400/90 to-amber-400/20",
    bgClass: "bg-amber-400",
    pulseBorderClass: "border-amber-400/10",
    textClass: "text-amber-400",
    highlightBorderClass: "border-transparent",
    normalBorderHoverClass: "hover:border-amber-400/35",
    titleHoverTextClass: "group-hover:text-amber-300",
    badgeBorderHoverClass: "group-hover:border-amber-400/30",
    darkBgClass: "from-[#1c1809] to-[#0a0a0a]",
    highlightBgDark: "bg-gradient-to-b from-[#1c1809] to-[#0a0a0a]",
    highlightBorderDark: "border border-white/5 hover:border-white/10",
    highlightShadowDark: "0 8px 16px -6px rgba(0,0,0,0.3), 0 0 15px 1px rgba(251, 191, 36, 0.12)",
    highlightBgLight: "bg-gradient-to-b from-[#FFFDF0] via-[#FFF9DF] to-[#FFFBF0]",
    highlightBorderLight: "border border-zinc-200/50 hover:border-zinc-300",
    highlightShadowLight: "0 12px 24px -8px rgba(215,108,0,0.15)",
    highlightBgSepia: "bg-gradient-to-b from-[#FFF5DC] via-[#FAF4E5] to-[#FAF4E5]",
    ...
    highlightShadowSepia: "0 12px 24px -8px rgba(217,119,6,0.18)",
    normalBgDark: "bg-[#0E0E0E]",
    normalBorderDark: "border border-white/5 hover:border-amber-400/35",
    normalShadowDark: "0 10px 20px -10px rgba(0,0,0,0.25)",
    normalBgLight: "bg-white",
    normalBorderLight: "border border-zinc-200 hover:border-amber-500/25",
    normalShadowLight: "0 4px 6px -1px rgba(0,0,0,0.05)",
  ...
  "實體店面與展覽": {
    ...
    highlightBorderClass: "border-transparent",
    normalBorderHoverClass: "hover:border-sky-500/35",
    titleHoverTextClass: "group-hover:text-sky-400",
    badgeBorderHoverClass: "group-hover:border-sky-500/30",
    darkBgClass: "from-[#031726] to-[#0a0a0a]",
    highlightBgDark: "bg-gradient-to-b from-[#031726] to-[#0a0a0a]",
    highlightBorderDark: "border border-white/5 hover:border-white/10",
    highlightShadowDark: "0 8px 16px -6px rgba(0,0,0,0.3), 0 0 15px 1px rgba(14, 165, 233, 0.12)",
    highlightBgLight: "bg-gradient-to-b from-[#FFFDF0] via-[#FFF9DF] to-[#FFFBF0]",
    highlightBorderLight: "border border-zinc-200/50 hover:border-zinc-300",
    highlightShadowLight: "0 12px 24px -8px rgba(215,108,0,0.15)",
    highlightBgSepia: "bg-gradient-to-b from-[#FFF5DC] via-[#FAF4E5] to-[#FAF4E5]",
    ...
    highlightShadowSepia: "0 12px 24px -8px rgba(217,119,6,0.18)",
    normalBgDark: "bg-[#0E0E0E]",
    normalBorderDark: "border border-white/5 hover:border-sky-500/35",
    normalShadowDark: "0 10px 20px -10px rgba(0,0,0,0.25)",
    normalBgLight: "bg-white",
    normalBorderLight: "border border-zinc-200 hover:border-amber-500/25",
    normalShadowLight: "0 4px 6px -1px rgba(0,0,0,0.05)",
  ...
  "平面海報廣告設計": {
    ...
    highlightBorderClass: "border-transparent",
    normalBorderHoverClass: "hover:border-blue-500/35",
    titleHoverTextClass: "group-hover:text-blue-400",
    badgeBorderHoverClass: "group-hover:border-blue-500/30",
    darkBgClass: "from-[#081329] to-[#0a0a0a]",
    highlightBgDark: "bg-gradient-to-b from-[#081329] to-[#0a0a0a]",
    highlightBorderDark: "border border-white/5 hover:border-white/10",
    highlightShadowDark: "0 8px 16px -6px rgba(0,0,0,0.3), 0 0 15px 1px rgba(59, 130, 246, 0.12)",
    highlightBgLight: "bg-gradient-to-b from-[#FFFDF0] via-[#FFF9DF] to-[#FFFBF0]",
    highlightBorderLight: "border border-zinc-200/50 hover:border-zinc-300",
    highlightShadowLight: "0 12px 24px -8px rgba(215,108,0,0.15)",
    highlightBgSepia: "bg-gradient-to-b from-[#FFF5DC] via-[#FAF4E5] to-[#FAF4E5]",
    ...
    highlightShadowSepia: "0 12px 24px -8px rgba(217,119,6,0.18)",
    normalBgDark: "bg-[#0E0E0E]",
    normalBorderDark: "border border-white/5 hover:border-blue-500/35",
    normalShadowDark: "0 10px 20px -10px rgba(0,0,0,0.25)",
    normalBgLight: "bg-white",
    normalBorderLight: "border border-zinc-200 hover:border-amber-500/25",
    normalShadowLight: "0 4px 6px -1px rgba(0,0,0,0.05)",
  ...
  "社群行銷小編圖文": {
    accent: "orange-400",
    rgbaGlow: "251, 146, 60",
    borderClass: "group-hover:border-orange-400/30",
    glowClass: "group-hover:shadow-orange-400/15",
    gradientClass: "from-orange-400/30 via-orange-400/90 to-orange-400/20",
    bgClass: "bg-orange-400",
    pulseBorderClass: "border-orange-400/10",
    textClass: "text-orange-400",
    highlightBorderClass: "border-transparent",
    normalBorderHoverClass: "hover:border-orange-400/35",
    titleHoverTextClass: "group-hover:text-orange-300",
    badgeBorderHoverClass: "group-hover:border-orange-400/30",
    darkBgClass: "from-[#1d1208] to-[#0a0a0a]",
    highlightBgDark: "bg-gradient-to-b from-[#1d1208] to-[#0a0a0a]",
    highlightBorderDark: "border border-white/5 hover:border-white/10",
    highlightShadowDark: "0 8px 16px -6px rgba(0,0,0,0.3), 0 0 15px 1px rgba(251, 146, 60, 0.12)",
    highlightBgLight: "bg-gradient-to-b from-[#FFFDF0] via-[#FFF9DF] to-[#FFFBF0]",
    highlightBorderLight: "border border-zinc-200/50 hover:border-zinc-300",
    highlightShadowLight: "0 12px 24px -8px rgba(215,108,0,0.15)",
    highlightBgSepia: "bg-gradient-to-b from-[#FFF5DC] via-[#FAF4E5] to-[#FAF4E5]",
    ...
    highlightShadowSepia: "0 12px 24px -8px rgba(217,119,6,0.18)",
    normalBgDark: "bg-[#0E0E0E]",
    normalBorderDark: "border border-white/5 hover:border-orange-400/35",
    normalShadowDark: "0 10px 20px -10px rgba(0,0,0,0.25)",
    normalBgLight: "bg-white",
    normalBorderLight: "border border-zinc-200 hover:border-amber-500/25",
    normalShadowLight: "0 4px 6px -1px rgba(0,0,0,0.05)",
